...
// bundle 里面是plist文件的
#define JKOCProjectToolBundlePlistName(file)  [[NSBundle mainBundle]pathForResource:JKOCProjectToolFrameworkBundlePath(file) ofType:@""] ? :[[NSBundle mainBundle]pathForResource:JKOCProjectToolBundlePath(file) ofType:@""]
